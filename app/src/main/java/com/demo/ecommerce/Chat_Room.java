...
import com.demo.ecommerce.adapter.ChatRAdapter;
import com.demo.ecommerce.bean.ChatBean;
...
public class Chat_Room extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        room_name = "Live Chat";//Utilities.getPreference(Chat_Room.this, Utilities.GROUP_NAME);
