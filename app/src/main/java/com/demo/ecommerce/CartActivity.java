...
import com.demo.ecommerce.adapter.CartListAdapter;
import com.demo.ecommerce.bean.Cart;
...
public class CartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isFirstRun("FIRST_PROMO_CODE")) {
            inputLayoutPromocode.setHelperText("Use FIRST50 promocode to avail 50% off");
        }
            ...
            case R.id.apply_promocode:
                ...
                if (promo_text.equals("FIRST50")) {
                    ...
                    if (isFirstRun("PROMO_CODE")) {
                        ...
                        Toast.makeText(this, "FIRST50 applied successfully", Toast.LENGTH_SHORT).show();
                    } else {
